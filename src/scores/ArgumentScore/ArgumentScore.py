...
if __name__ == "__main__":
    ...
    df["topic"] = [
        "what is better, laptop or desktop",
        "what is better, laptop or desktop",
        "what is the highest mountain in the world?",
    ]
    df["title"] = [
        "laptop is more usefull then desktop",
        "laptop or desktop for study",
        "Everest - excited experience",
    ]
    df["snippet"] = [
        "firstly man can bringt it easy everywhere. Laptop is almost powerfull enough for almose use-cases",
        "it is depend von what u study. I think laptop is comfortable to travel, computer science students need PC",
